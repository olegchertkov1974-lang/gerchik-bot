...
const REGIME_PATH = path.join(__dirname, '..', 'data', 'market-regime.json');
const fs = require('fs');
const app = express();
...
app.get('/api/stats', (req, res) => {
  let marketRegime = { regime: 'unknown', atrPct: 0, change24h: 0, botState: 'АКТИВЕН', consecutiveLosses: 0, updatedAt: null };
  try { marketRegime = JSON.parse(fs.readFileSync(REGIME_PATH, 'utf8')); } catch (_) {}
